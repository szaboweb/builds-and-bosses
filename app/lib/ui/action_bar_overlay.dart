                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildSkillCard(
                      ...
                      isSelected:
                          game.selectedActionNotifier.value ==
                          ActionType.ranged,
                      onTap: () =>
                          game.selectedActionNotifier.value = ActionType.ranged,
                    ),
                    const SizedBox(width: 12),
                    _buildSkillCard(
                      ...
                      isSelected:
                          game.selectedActionNotifier.value == ActionType.spell,
                      onTap: () =>
                          game.selectedActionNotifier.value = ActionType.spell,
                    ),
                    const SizedBox(width: 12),
                          ...
                          : SingleChildScrollView(
                              ...
                              child: Row(
                                children: List.generate(
                                  ...
                                  (index) {
                                    final action =
                                        game.actionQueue.actions[index];
                                    return Padding(
