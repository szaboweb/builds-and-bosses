              ...
              if (phase == GamePhase.realtime) ...[
                OutlinedButton.icon(
                  style: OutlinedButton.styleFrom(
                    ...
                    backgroundColor: const Color(0xFF1C1829).withValues(alpha: 0.8),
                  ...
                  icon: const Icon(Icons.build, size: 18, color: Color(0xFFFFD54F)),
                  label: const Text(
                    'TERVEZŐASZTAL [B]',
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 6),
              const Icon(Icons.warning_amber, color: Color(0xFFFF5252), size: 16),
            ],
          ),
          const SizedBox(height: 6),
          Row(
